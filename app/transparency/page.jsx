...
export default function TransparencyPage() {
  ...
  const expenseBreakdown = [
    {
      ...
      amount: currentData.totalDistributed * 0.75,
      percentage: 75,
      color: "#5DADE2",
    },
    {
      category: "Program Operations",
      amount: currentData.totalDistributed * 0.15,
      percentage: 15,
      color: "#FFC857",
    },
    {
      category: "Skills Training Materials",
      amount: currentData.totalDistributed * 0.1,
      percentage: 10,
      color: "#10B981",
    },
  ];
  ...
  const adminBreakdown = [
    {
      ...
      amount: currentData.adminCosts * 0.6,
      percentage: 60,
      color: "#8B5CF6",
    },
    {
      category: "Office & Utilities",
      amount: currentData.adminCosts * 0.25,
      percentage: 25,
      color: "#F59E0B",
    },
    {
      category: "Technology & Systems",
      amount: currentData.adminCosts * 0.15,
      percentage: 15,
      color: "#EF4444",
    },
  ];
  ...
  const recentTransactions = [
    ...
    },
    {
      ...
      type: "Distribution",
      amount: -25000,
      recipient: "Lagos Community Kitchen",
    ...
    },
    {
      ...
      type: "Distribution",
      amount: -15000,
      recipient: "Skills Training Program",
      method: "Cash",
    },
    {
      date: "2024-11-11",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              ...
              donations are used, track our impact, and access all our financial
              records and reports.
            </p>
          </motion.div>
        </div>
                      ...
                      >
                        <div className="w-full flex flex-col space-y-1">
                          <motion.div
                            initial={{ height: 0 }}
                            animate={{
                              height: `${(month.donations / 2000000) * 100}%`,
                            }}
                          ...
                          <motion.div
                            ...
                            animate={{
                              height: `${
                                (month.distributions / 2000000) * 100
                              }%`,
                            }}
                            transition={{
                              delay: index * 0.1 + 0.2,
